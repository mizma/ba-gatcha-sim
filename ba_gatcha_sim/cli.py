...
@click.command()
@click.option("--old", "-o", is_flag=True, help="run old gatcha sim")
@click.option(
    "--reset",
    "-r",
    is_flag=True,
...
@click.option("--mileage", "-m", is_flag=True, help="use mileage tickets")
@click.option("--new", "-n", is_flag=True, help="run new gatcha sim")
@click.option(
    "--target",
    "-t",
    default=2,
...
@click.option("--verbose", "-v", count=True, help="output in verbose mode")
